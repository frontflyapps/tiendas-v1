...
branches=(prod-PymesBulevar prod-Dujo prod-ElGuajirito prod-GranComercial prod-Acubamos prod-Apululu prod-Mercado+ prod-Almacen52 prod-ALCABService prod-BCSuministros prod-Bianca prod-DCero prod-Donato prod-DondeDorian prod-LaLuciana prod-LaPolimita prod-MisterDamian prod-Pruebalo prod-Atec  prod-Caracol prod-ElAjibe prod-Gelato prod-GranComerial-Mayoristas prod-GranFerretero prod-HomeDeli prod-LaTorre prod-LasPraderas prod-MCV prod-MM_Caribe prod-Marlin prod-MercadoMontequin prod-MiBulevar prod-MiBulevar-Alcansan prod-MiBulevar-Aligan prod-MiBulevar-ComercioCienfueg prod-MiBulevar-Cupetcfg prod-MiBulevar-Cupetgrm prod-MiBulevar-Cupethol prod-MiBulevar-Cupetltu prod-MiBulevar-Epueblo prod-MiBulevar-Etecsa prod-MiBulevar-Genesis prod-MiBulevar-Mercatuaba prod-MiBulevar-Ofa prod-MiBulevar-TiendasPatrimonio prod-MiBulevar-Trd prod-MundoCopextel prod-Noduco prod-OfertasTravel prod-OpticasTheia prod-Palmares prod-PeopleGoTo prod-VeoVeo prod-Cluster37 prod-Cubanearme prod-MarketRey)
