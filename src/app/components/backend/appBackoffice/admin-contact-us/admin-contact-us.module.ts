...
import { AdminContactUsRoutingModule } from './admin-contact-us-routing.module';
...
@NgModule({
  ...
  declarations: [AdminContactUsTableComponent, DialogEditMessagesComponent],
  entryComponents: [],
})
