...
@Component({
  selector: 'app-messenger-table',
  templateUrl: './messenger-table.component.html',
  styleUrls: ['./messenger-table.component.scss'],
})
export class MessengerTableComponent implements OnInit {
  @Input() role;
  urlImage: string;
  innerWidth: any;
  applyStyle = false;
