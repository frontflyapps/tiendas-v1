...
import { AdminRgionsRoutingModule } from './admin-regions-routing.module';
...
@NgModule({
  ...
  declarations: [RegionsTableComponent, DialogAddEditRegionsComponent],
  entryComponents: [],
})
